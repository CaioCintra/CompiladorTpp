...
def p_indice_error(p):
    ...
    print("Erro na definicao do indice. Expressao ou indice:p[0]:{p0}, p[1]:{p1}, p[2]:{p2}, p[3]:{p3}".format(
...
def p_cabecalho_error(p):
    ...
    print("Erro ao criar o cabeçalho:p[0]:",p[0],", p[1]:",p[1],", p[2]:",p[2],", p[3]:",p[3],", p[4]:",p[4],", p[5]:",p[5]," p[6]:",p[6])
    error_line = p.lineno(2)
    father = MyNode(name='ERROR::{}'.format(error_line), type='ERROR')
    logging.error(
        "Syntax error parsing index rule at line {}".format(error_line))
...
def p_parametro_error(p):
    ...
    """
    print("Erro de parametro:p[0]:",p[0],", p[1]:",p[1],", p[2]:",p[2])
    error_line = p.lineno(2)
    father = MyNode(name='ERROR::{}'.format(error_line), type='ERROR')
    logging.error(
        "Syntax error parsing index rule at line {}".format(error_line))
...
def p_se_error(p):
    ...
    """
    if(len(p)==8):
        print("Erro na expressão usando o SE:p[0]:",p[0],", p[1]:",p[1],", p[2]:",p[2],", p[3]:",p[3],", p[4]:",p[4],", p[5]:",p[5]," p[6]:",p[6]," p[7]:",p[7])
    else:
        print("Erro na expressão usando o SE:p[0]:",p[0],", p[1]:",p[1],", p[2]:",p[2],", p[3]:",p[3],", p[4]:",p[4],", p[5]:",p[5])
    error_line = p.lineno(2)
    father = MyNode(name='ERROR::{}'.format(error_line), type='ERROR')
    logging.error(
        "Syntax error parsing index rule at line {}".format(error_line))
...
def p_repita_error(p):
    ...
    print("Erro no REPITA:p[0]:",p[0],", p[1]:",p[1],", p[2]:",p[2],", p[3]:",p[3],", p[4]:",p[4])
    error_line = p.lineno(2)
    father = MyNode(name='ERROR::{}'.format(error_line), type='ERROR')
    logging.error(
        "Syntax error parsing index rule at line {}".format(error_line))
...
def p_leia_error(p):
    ...
    print("Erro no LEIA:p[0]:",p[0],", p[1]:",p[1],", p[2]:",p[2],", p[3]:",p[3],", p[4]:",p[4])
    error_line = p.lineno(2)
    father = MyNode(name='ERROR::{}'.format(error_line), type='ERROR')
    logging.error(
        "Syntax error parsing index rule at line {}".format(error_line))
...
def p_fator_error(p):
    """fator : ABRE_PARENTESE error FECHA_PARENTESE
        """
    print("Erro na definição de sintaxe do fator.Expressao:p[0]:",p[0],", p[1]:",p[1],", p[2]:",p[2],", p[3]:",p[3])
    error_line = p.lineno(2)
    father = MyNode(name='ERROR::{}'.format(error_line), type='ERROR')
    logging.error(
        "Syntax error parsing index rule at line {}".format(error_line))
